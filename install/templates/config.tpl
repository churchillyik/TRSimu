...
<div class="lbox">
	...
	<td><span class="f9 c6">Beginners protection lenght:</span></td><td><input name="beginner" type="text" id="autodeltime" value="3600*12" size="15"></td></tr><tr></tr>
	</table>
</div>
<!-- </LEFT BOX - SERVER RELATED> -->
...
<div class="rbox">
	...
	<tr><td><span class="f9 c6">GPack Design:</span></td><td><select name="gplocate">
	  <option value="gpack/travian_redesign/" selected="selected">TravianX T3.6</option></select></td></tr>
