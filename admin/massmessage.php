...
if (isset($_GET['send']) && isset($_GET['from']))
{
	...
	{
		echo header("Location: massmessage.php?send=true&from=", $_GET['from'] + $max_per_pass);
	}
	else
	{
		$done = true;
...
<div class="wrapper">
	...
	<?php include(dirname(__FILE__)."/../Templates/header.tpl"); ?>
	<div id="mid">
		<?php include(dirname(__FILE__)."/../Templates/menu.tpl"); ?>
	...
	<div class="clear"></div>
	<?php include(dirname(__FILE__)."/../Templates/footer.tpl"); ?>
	<div id="ce"></div>
</div>
</body>
</html>
