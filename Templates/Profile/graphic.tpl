    ...
    <table cellpadding="1" cellspacing="1" id="download">
        ...
        <tbody>
                <tr>
                    ...
                    <td class="down"><a href="gpack/download/travian_default_en.zip" target="_blank">download</a></td>
                </tr>
<tr>
					...
					<td class="down"><a href="gpack/download/revival_en_new.zip" target="_blank">Download</a></td>
				</tr>
<tr>
					...
					<td class="down"><a href="gpack/download/travian_redesign.zip" target="_blank">Download</a></td>
				</tr>
                    </tbody>
    </table>
    <?php
