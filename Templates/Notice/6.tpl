...
<thead>
	...
	<tr>
		...
		?>
		<td class="sent">发送：</td>
		<td>于 <?php echo $date[0]."<span> at ".$date[1]; ?></span><span> </span></td>
	</tr>
</thead>
<tbody>
	...
	<tr>
		<td colspan="2" class="report_content">
			...
			<tr>
				...
				<td colspan="10"><a href="spieler.php?uid=7101">Rajewski</a> 来自于村庄 <a href="karte.php?d=410751&amp;c=c6">New village</a></td>
			</tr>
			</thead>
			<tbody class="units">
			<tr>
			...
			<tr>
				...
				<td colspan="10">
					<div class="res">
						<img class="r1" src="img/x.gif" alt="Lumber" title="Lumber" />1 | 
						<img class="r2" src="img/x.gif" alt="Clay" title="Clay" />0 | 
						<img class="r3" src="img/x.gif" alt="Iron" title="Iron" />0 | 
						<img class="r4" src="img/x.gif" alt="Crop" title="Crop" />208
					</div>
					<div class="carry">
						<img class="car" src="img/x.gif" alt="carry" title="carry" />209/16500
					</div>
				</td>
			</tr>
			</tbody>
			...
			<tr>
			<td>&nbsp;</td>
			<td><img src="img/x.gif" class="unit u31" title="Rat" alt="Rat" /></td>
			<td><img src="img/x.gif" class="unit u32" title="Spider" alt="Spider" /></td>
			<td><img src="img/x.gif" class="unit u33" title="Snake" alt="Snake" /></td>
			<td><img src="img/x.gif" class="unit u34" title="Bat" alt="Bat" /></td>
			<td><img src="img/x.gif" class="unit u35" title="Wild Boar" alt="Wild Boar" /></td>
			<td><img src="img/x.gif" class="unit u36" title="Wolf" alt="Wolf" /></td>
			<td><img src="img/x.gif" class="unit u37" title="Bear" alt="Bear" /></td>
			<td><img src="img/x.gif" class="unit u38" title="Crocodile" alt="Crocodile" /></td>
			<td><img src="img/x.gif" class="unit u39" title="Tiger" alt="Tiger" /></td>
			<td><img src="img/x.gif" class="unit u40" title="Elephant" alt="Elephant" /></td>
			</tr>
			<tr>
			<th>Troops</th>
			<td>1</td>
