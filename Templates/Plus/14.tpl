...
if ($totalT <= $totalR)
{
    ...
    mysql_query("INSERT INTO ".TB_PREFIX."gold_fin_log VALUES ('".(mysql_num_rows($goldlog) + 1)."', '".$village->wid."', '1:1交易成功')") or die(mysql_error());
	echo "&nbsp;&nbsp; 与电脑商人的资源交易成功";
}
else
{
	echo "&nbsp;&nbsp; 与电脑商人的资源交易失败";
    mysql_query("INSERT INTO ".TB_PREFIX."gold_fin_log VALUES ('".(mysql_num_rows($goldlog) + 1)."', '".$village->wid."', '1:1交易失败')") or die(mysql_error());
}
