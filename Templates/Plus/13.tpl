...
<form method="get" action="plus.php">
	...
	<div align="center">
		...
		<tr>
			<td align="center" width="25%"><img class="r1" src="img/x.gif" alt="木材" title="木材" />木材</td>
			<td align="center" width="25%"><img class="r2" src="img/x.gif" alt="粘土" title="粘土" />粘土</td>
			<td align="center" width="25%"><img class="r3" src="img/x.gif" alt="铁矿" title="铁矿" />铁矿</td>
			<td align="center" width="25%"><img class="r4" src="img/x.gif" alt="粮食" title="粮食" />粮食</td>
		</tr>
		<tr>
			<?php
		...
		<tr>
			<td colspan="4" align="center">
				<input type="submit" value="Trade 1:1" name="B1">
			</td>
		</tr>
		</table>
	</div>
