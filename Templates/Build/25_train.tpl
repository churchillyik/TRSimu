...
if($data['u' . $session->tribe . '0'] < $max_settlers AND ($building->getTypeLevel(25) == 10 OR $building->getTypeLevel(25) == 20) AND $can_settle != 0) {
?>
...
<?php
  ...
  } elseif($building->getTypeLevel(25) == 20) {
