...
?>
	...
	<span class="little_res"><?php echo $uprequire['wood']; ?></span> | <img class="r2" src="img/x.gif" alt="粘土" title="粘土" />
	<span class="little_res"><?php echo $uprequire['clay']; ?></span> | <img class="r3" src="img/x.gif" alt="铁矿" title="铁矿" />
	<span class="little_res"><?php echo $uprequire['iron']; ?></span> | <img class="r4" src="img/x.gif" alt="粮食" title="粮食" />
	<span class="little_res"><?php echo $uprequire['crop']; ?></span> | <img class="r5" src="img/x.gif" alt="粮食消耗" title="粮食消耗" />
	<?php echo $uprequire['pop']; ?> | <img class="clock" src="img/x.gif" alt="建造时间" title="建造时间" />
...
<?php 
	...
	if($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) >= 1)
	{
		...
		"&r3=".$uprequire['iron'].
		"&r4=".$uprequire['crop'].
		"\" title=\"NPC trade\"><img class=\"npc\" src=\"img/x.gif\" alt=\"NPC trade\" title=\"NPC trade\" /></a>";
	} 
?>
<br />
<?php
	...
	{
		echo "<span class=\"none\">已经有建筑在建造当中（等待中）</span>";
	}
	else if ($bindicate == 4) 
	{
	...
	else if ($bindicate == 9) 
	{
		...
		echo $village->resarray['f'.$id] + 1;
		echo "</a><span class=\"none\">（等待中）</span>";
	}
}
?>