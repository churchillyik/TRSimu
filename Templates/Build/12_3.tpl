...
<tr>
	...
	echo "<tr><td class=\"desc\">
		...
		<div class=\"details\"><img class=\"r1\" src=\"img/x.gif\" alt=\"木材\" title=\"木材\" />".${'bs'.$i}['wood']."|
	...
	{
		echo "|<a href=\"build.php?gid=17&t=3&r1=".${'bs'.$i}['wood']."&r2=".${'bs'.$i}['clay']."&r3=".${'bs'.$i}['iron']."&r4=".${'bs'.$i}['crop']."\" title=\"与电脑商人交易\">
	...
	for ($i = 22; $i <= 26; $i++)
	{
		if ($technology->getTech($i))
		{
			...
			if (${'bs'.$i}['wood'] > $village->maxstore 
				...
				|| ${'bs'.$i}['iron'] > $village->maxstore)
			{
				echo "<br><span class=\"none\">所需资源超过仓库容量，请先升级仓库</span>
					</div>
					</td>";
				echo "<td class=\"act\">
					<div class=\"none\">升级<br>仓库</div>
