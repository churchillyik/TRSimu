...
if (isset($qact))
{
	...
	case '6':
		...
		$Subject = "来自任务管理员的讯息";
		$Message = "任务管理员提醒您去领取一份不错的奖励。<br /><br />提示：该讯息是游戏系统自动生成的。并不需要回复。";
...
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/> 欢迎来到 <?php echo SERVER_NAME; ?>！<\/h1><br \/><i>&bdquo;你现在已经是这座小村庄的首领啦。在游戏的开始阶段，我将会作为你身边的顾问（页面右侧）。&rdquo;<\/i><br \/><br \/><span id=\"qst_accpt\"><a class=\"qle\" href=\"javascript: qst_next('','enter'); \">开始第一个任务<\/a><a class=\"qri\" href=\"javascript: qst_fhandle();\">我想自己\u00a0随\u00a0便\u00a0看\u00a0看。<\/a><input type=\"hidden\" id=\"qst_val\" value=\"2\" \/><br \/><br \/><br \/><a class=\"qri\" href=\"javascript: qst_next('','skip');\">我不想做任务。<\/a><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"intro\"><\/div>\n\t\t","number":null,"reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>g","msrc":"<?php echo $messagelol; ?>","altstep":1}
...
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/> 任务 1：伐木场<\/h1><br \/><i>&bdquo;在你的村庄周围有4处树林，在其中一处建造一座伐木场。对于村庄建设来说，木材是一种非常重要的资源。&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\">目标：<\/p>建造一座伐木场。<\/div><br \/><span id=\"qst_accpt\"><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"wood\"><\/div>\n\t\t","number":"-1","reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>","msrc":"<?php echo $messagelol; ?>","altstep":0}
...
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/> 任务 1：伐木场<\/h1><br \/><i>&bdquo;很好，这样你就能获得更多的木材了，是不是轻而易举呀。&rdquo;<\/i><br \/><br \/><input type=\"hidden\" id=\"qst_val\" value=\"2\" \/><div class=\"rew\"><p class=\"ta_aw\">你的奖励：<\/p>伐木场立即建造完成。<br \/><\/div><br \/><span id=\"qst_accpt\"><a href=\"javascript: qst_next('','2');\">继续下一个任务。<\/a><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"wood\"><\/div>\n\t\t","number":"-1","reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>","msrc":"<?php echo $messagelol; ?>","altstep":0}
...
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/> 任务 2：粮食<\/h1><br \/><i>&bdquo;现在你的村民工作了一天已经很饿了，先建造一座农场来满足他们的需要吧。在农田建好后记得回来哦。&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\">目标：<\/p>建造一座农场。<\/div><br \/><span id=\"qst_accpt\"><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"farm\"><\/div>\n\t\t","number":"-2","reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>","msrc":"<?php echo $messagelol; ?>","altstep":0}
...
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/> 任务 2：粮食<\/h1><br \/><i>&bdquo;非常好，现在你的村民又有吃的了。&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\"><input type=\"hidden\" id=\"qst_val\" value=\"2\" \/>奖励：<\/p><img src=\"img\/x.gif\" class=\"r1\" alt=\"木材\" title=\"木材\" \/>50&nbsp;&nbsp;<img src=\"img\/x.gif\" class=\"r2\" alt=\"粘土\" title=\"粘土\" \/>60&nbsp;&nbsp;<img src=\"img\/x.gif\" class=\"r3\" alt=\"铁矿\" title=\"铁矿\" \/>30&nbsp;&nbsp;<img src=\"img\/x.gif\" class=\"r4\" alt=\"粮食\" title=\"粮食\" \/>10&nbsp;&nbsp;<\/div><br \/><span id=\"qst_accpt\"><a href=\"javascript: qst_next('','3');\">继续下一个任务。<\/a><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"farm\"><\/div>\n\t\t","number":2,"reward":{"plus":1},"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>g","msrc":"<?php echo $messagelol; ?>","altstep":0}
