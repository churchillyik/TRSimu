...
<thead>
	<tr>
		<th colspan="5">最成功的联盟（攻击）
			<div id="submenu">
				<a title="防御者" href="statistiken.php?id=42"><img class="btn_def" src="img/x.gif" alt="防御者" /></a>
				<a title="攻击者" href="statistiken.php?id=4"><img class="active btn_off" src="img/x.gif" alt="攻击者" /></a>
			</div>
		</th>
	</tr>
	<tr>
		...
		for ($i = $start; $i < $start + 20; $i++)
		{
			if (isset($ranking[$i]['name']) && $ranking[$i] != "pad")
			{
				...
				echo $ranking[$i]['players']."</td><td class=\"av \" >"
					.$ranking[$i]['avg']."</td><td class=\"po \">".$ranking[$i]['totalap']."</td></tr>";
			}
		}
	}
	else
