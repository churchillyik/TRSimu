<h1>
	<img class="unit u30" src="img/x.gif" alt="拓荒者" title="拓荒者" /> 拓荒者 
...
<tr>
	<th>训练时间</th>
	<td><img class="clock" src="img/x.gif" alt="训练时间" title="训练时间" /> 6:18:20</td>
</tr>
</tbody>
</table>

<img id="big_unit" class="big_u30" src="img/x.gif" alt="拓荒者" title="拓荒者" />
<div id="t_desc">开拓者是一群勇于接受挑战及久经训练的出色人材，他们能够为你建造出一座新的村落。
<br /><br />
建造一座新的村庄会面对种种不同的挑战，因此需要3个开拓者同心合力才有机会成功。同时，他们需要各750单位数量的资源去发展一些基本设施。</div>
<div id="prereqs"><b>开发要求</b><br /><a href="manual.php?typ=4&amp;gid=26">皇宫</a> 等级 10 或 <a href="manual.php?typ=4&amp;gid=25">行宫</a> 等级 10</div>
<map id="nav" name="nav">
	<area href="manual.php?typ=1&amp;s=29" title="上一页" coords="0,0,45,18" shape="rect" alt="" />
