<h1>
	<img class="unit ugeb" src="img/x.gif"> 伐木场
</h1>
<img class="building g1" src="img/x.gif" alt="伐木场" title="伐木场" />
伐木场是砍伐木材的地方。伐木场等级越高，单位时间内能砍伐的木材也就越多。
<p>
	...
	<span class="dur">
	<img class="clock" alt="建造时间" title="建造时间" src="img/x.gif" />0:04:20
	</span>
</p>
<p>
	<b>开发要求</b><br />无
