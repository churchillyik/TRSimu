<h1>
	<img class="unit ugeb" src="img/x.gif"> Town Hall
</h1>
...
<p>
	...
	<img class="r1" src="img/x.gif" alt="Lumber" title="Lumber" />1250 | 
	<img class="r2" src="img/x.gif" alt="Clay" title="Clay" />1110 | 
	<img class="r3" src="img/x.gif" alt="Iron" title="Iron" />1260 | 
	<img class="r4" src="img/x.gif" alt="Crop" title="Crop" />600 | 
	<img class="r5" src="img/x.gif" alt="Crop consumption" title="Crop consumption" />4 | 
	<span class="dur">
	<img class="clock" alt="duration" title="duration" src="img/x.gif" />3:28:20
	</span>
</p>
<p>
