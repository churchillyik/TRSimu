<h1>
	<img class="unit ugeb" src="img/x.gif"> Horse Drinking Trough
</h1>
<img class="building g41" src="img/x.gif" alt="Horse Drinking Trough" title="Horse Drinking Trough" />
The horse drinking trough cares for the wellbeing of your horses and therefore also increases the speed of their training.<br /><br />
...
<p>
	...
	<img class="r4" src="img/x.gif" alt="Crop" title="Crop" />540 | 
