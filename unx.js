...
function Popup(i, j, sc)
{
	...
	if (pb != null)
	{
		...
		+ sc + '=' + i 
		+ '&typ=' + j 
		+ '" width="412" height="440" border="0"></iframe>' 
		+ '</div>';
		pb.innerHTML = tc;
		uc();
	}
...
function xe(ye)
{
	var ze = document.getElementById('map_makelarge');
	ze.className = ye? 'loading' : '';
}
function $e(_e)
{
	var af;
...
function ve()
{
	...
	{
		xe(true);
		fd('ajax.php?f=kp&z=' + lf(m_c.z.x, m_c.z.y), 
			function(mf)
			{
				xe(false);
